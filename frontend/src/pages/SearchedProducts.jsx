  ...
  return (
    <>
      <Helmet>
        ...
        <title>{`Search Results for "${searchQuery}" | Farmers Help`}</title>

        
        {/* Keywords */}
        <meta
          name="keywords"
          content={`${searchQuery}, buy ${searchQuery}, ${searchQuery} deals, Farmers Help search, online shopping`}
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content={`Search: ${searchQuery} | Farmers Help`}
        />
