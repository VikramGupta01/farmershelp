  ...
  return (
    <div className="px-4 sm:px-0">
      ...
      </div>
      {
        ...
        coupons.length===0?<div className="flex flex-col items-center justify-center py-10 text-center bg-emerald-50 rounded-xl shadow-inner border border-emerald-200">
        <BadgePercent className="text-emerald-500"/>
        ...
        {coupons.map((coupon) => (
          <div
            key={coupon._id}
            className="relative group bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-2xl shadow-lg p-5 transition-all duration-300 hover:scale-105 border-t-4 border-emerald-500"
          >
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md relative shadow-lg">
            ...
            <form onSubmit={handleAddCoupon} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isAdding}
                className="w-full py-2 px-4 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition"
              >
                {isAdding ? "Adding..." : "Add"}
              </button>
            </form>
