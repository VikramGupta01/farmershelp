          ...
          >
            ...
            <div className="p-5 border-t border-gray-100">
              ...
              <div className="flex gap-3">
                <button className="flex-1 py-2 px-3 text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-md flex items-center justify-center transition-all duration-200 border border-emerald-100"
      ...
      >
        <form className="space-y-4 max-h-[80vh] overflow-y-auto" onSubmit={handleEditSubmit}> 
          ...
          {/* <div>
              ...
              <select
                name="featuredCategory"
                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-indigo-500 transition-colors"
