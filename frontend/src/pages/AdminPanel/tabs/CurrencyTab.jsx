...
export default function CurrencyTab() {
  ...
  return (
    <div className="w-full max-w-lg mx-auto px-4 py-6 bg-white shadow-md rounded-2xl sm:px-8 sm:py-10">
      <h2 className="text-xl sm:text-2xl font-bold text-emerald-800 mb-6 text-center border-b pb-2">
        ...
        <div className="space-y-6">
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            ...
            <input
              ...
              className="w-32 sm:w-36 px-4 py-2 border border-gray-300 rounded-md 
                         ...
                         text-right font-medium text-emerald-800"
              step="0.1"
              autoFocus
            />
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <button
              ...
              disabled={isUpdating}
              className="bg-emerald-600 hover:bg-emerald-700 text-white w-full sm:w-40 py-2.5 
