      ...
      <div className="bg-white rounded-2xl  shadow-md p-4">
        ...
        <div className="flex gap-4">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <button
              ...
              disabled={isUpdating}
              className="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors shadow-sm disabled:opacity-75"
            >
