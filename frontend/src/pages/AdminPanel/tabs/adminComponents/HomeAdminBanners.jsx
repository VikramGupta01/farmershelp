...
function HomeAdminBanners() {
  ...
  return (
    <>
      <section className="bg-emerald-50 rounded-2xl shadow-md p-3 sm:p-6">
              ...
              <div className="p-5">
                ...
                <div className="flex gap-3 mt-4 justify-end">
                  <button
                    ...
                    className="p-2 hover:bg-emerald-100 rounded-full transition-colors duration-200 text-emerald-600"
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              ...
              <label className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 cursor-pointer group">
                <Upload className="w-5 h-5 mr-2 text-gray-500 group-hover:text-emerald-500 transition-colors" />
          ...
          <button
            type="submit"
            disabled={isAdding}
            className="w-full px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors shadow-sm"
          >
