              ...
              <div className="p-3 sm:p-4">
                ...
                <div className="flex gap-2 mt-3 sm:mt-4 justify-end">
                  <button
                    ...
                    className="p-1.5 sm:p-2 hover:bg-emerald-100 rounded-full transition-colors duration-200 text-emerald-600"
                  >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <textarea
                name="description"
                className="w-full h-[100px] px-3 py-2 border rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
