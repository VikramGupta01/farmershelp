      ...
      {isEditing ? (
        <div className="grid gap-4">
          ...
          <div className="flex gap-4 mt-4">
            <button
              className="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2 rounded-lg transition duration-200"
        ...
        isLoading ?<SmallLoader/> : (
          <div className="space-y-4 text-gray-700">
            ...
            <button
              className="mt-4 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2 rounded-lg transition duration-200"
