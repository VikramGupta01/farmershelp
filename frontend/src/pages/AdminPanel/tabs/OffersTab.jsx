          ...
          <div className="p-5 flex flex-col flex-grow border-t border-gray-100">
            ...
            <div className="mt-auto flex gap-3">
              <button
                ...
                className="flex-1 py-2 px-3 text-emerald-600 hover:text-white hover:bg-emerald-600 rounded-lg flex items-center justify-center transition-all duration-200 border border-emerald-200"
              >
