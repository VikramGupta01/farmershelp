...
const Signup = () => {
  ...
  return (
    ...
    <Helmet>
  {/* Title */}
  <title>Create Your Account | Join Farmers Help Today</title>
  ...
  {/* Open Graph */}
  <meta property="og:title" content="Sign Up | Farmers Help" />
            ...
            <div>
              <button
                ...
                className={`group relative w-full flex justify-center py-3 px-4 border border-transparent rounded-lg text-white ${
                  agreeToTerms ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-emerald-400 cursor-not-allowed'
